...
Repository Map is a HydraDB-backed VS Code view of your current project. It shows bounded repository structure, exact source evidence, traces, observable agent activity, graph changes, and saved system lenses.

Normal installation is plug-and-play:

1. Open a local project folder in VS Code.
2. Run **Repository Map: Set Up Repository Map**.
3. Select or create a HydraDB account profile.
4. Enter the API key and this project's database in masked fields.
5. Let Repository Map test read access.
...
See the [full project documentation](https://github.com/RETR0-OS/RepoMapper/tree/main/docs) for views, workflows, trust boundaries, Compare, Preserve, Observe, and agent setup.
